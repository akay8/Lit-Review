...
More recent paper on unsaturated iodine cells. Uses modulated transfer spectroscopy (MTS), where probe beam in SAS is modulated using am AOM to provide a locking signal \cite{2024zhangHighPerformanceMolecularIodine}
