...
\section{OC2 inspiration}

Rach Dawson designed portable robust cell mount system for OPMs for prosthetics - 
see here \cite{2023dawsonPortableSinglebeamCesiumZerofield}

\smallskip

James thesis - good for bonder temperature and degassing behaviour, amongst
many  other things \cite{2017mcgilliganMicrofabricatedDiffractiveOpticsQuantum}

\smallskip

SPAD with 2 photon clock - R Beard's paper \cite{2024beardTwophotonRubidiumClockDetecting}
